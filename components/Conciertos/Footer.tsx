    ...
    <>
      <Wrapper bgColor={backgroundColor}>
        <Container bgColor={backgroundColor}>
          <Column>
            <Title bgColor={backgroundColor}>Nosotros</Title>
            ...
            <Title bgColor={backgroundColor}>Redes Socialess</Title>
          </Column>
          <Column>
            <Title bgColor={backgroundColor}>Publicaciones</Title>
            <Description bgColor={backgroundColor}>
              Estudios publicados por el Dr. Puerta
            </Description>
          </Column>
          <Column>
            <Title bgColor={backgroundColor}>Links</Title>
            <Description bgColor={backgroundColor}>
              <ul>
                <li>Inicio</li>
                <li>Dr. Puerta</li>
          ...
          <Column>
            <Title bgColor={backgroundColor}>Ubicación</Title>
            <Description bgColor={backgroundColor}>
              <ul>
                <li className="home">Contacto:</li>
                <li></li>
                <li>Fijo: +6 04 268 5436</li>
                <li>Cel: 318 898 1046.</li>
                <li className="home">Dirección</li>
                <li></li>
